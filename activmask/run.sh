...
#python -u main.py train --config config/synth_unet_noactdiff.yml
...
python -u main.py train --config config/synth_ae_maskonly.yml
python -u main.py train --config config/synth_unet_maskonly.yml
